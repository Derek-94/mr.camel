const mockData = [
  ...
  {
    title: '나이키 오버핏 올드스쿨 빅로고 배색 바람막이 XL 바막 웜업 아노락 자켓',
    brand: '나이키',
    price: 35000,
  },
  ...
  { title: '(풀구성 정품M)구찌 로고 후드티', brand: '구찌', price: '구찌' },
  ...
  {
    title: '스톤아일랜드 맨투맨/아미맨투맨/메종키츠네/톰브라운/구찌/cp컴퍼니/스투시',
    brand: '스톤아일랜드',
    price: 280000,
  },
  ...
  {
    title: '(개인)[정품] 스톤아일랜드 쉐도우프로젝트 스트라이프 나일론 메탈 자켓 판매',
    brand: '스톤아일랜드',
    price: 550000,
  },
